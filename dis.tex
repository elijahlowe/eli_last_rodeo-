...
\begin{abstract}
Tunicates are invertebrate chordates and are the sister group to the vertebrates. Although tunicates share little morphological resemblance to vertebrates in their adult stage, they do share several features in their larval stage: a dorsal hollow neural tube, gill slits, and a post-anal tail, containing a notochord\textemdash a group of cells organized in a rod shaped structure?which is the key features that classify the phyla. Within the tunicates, several ascidians have undergone tail-loss, many of them being Molgulidae. Hybrids have been produced through the cross fertilization of these two \textit{Molgula} species (\textit{Molgula occulta} and \textit{Molgula oculata}), and no other solitary \textit{Molgula} species have been known to hybridize. Here we have sequenced the transcriptomes of several developmental stages of \textit{M. occulta}, \textit{M. oculata}\textemdash two closely related, free-spawning ascidian species, and their hybrid, with no available reference genome, in order to study the mechanisms behind tail lost in \textit{M. occulta}. We were first presented with the problem of identifying the best pipeline for the \textit{de novo} assembly of our species, in which we determined processing reads through digital normalization, a redundancy reduction step, had less of an effect on assemblies than does the assembler used. We then sequenced and assembled the genomes of  \textit{M. occulta}, \textit{M. oculata} and a more distance species, \textit{M. occidentalis}. This allowed us to characterized the genomes, discovering the species are more divergent then they appear phenotypically and build better gene models. Through differential expression analysis we were able to determine that \textit{M. oculata} and the hybrid appear to have the overlap transcripts being up-regulated during the formation of the ascidian tail, and that the expression was being rescued predominately by the tailed species.
\end{abstract}
